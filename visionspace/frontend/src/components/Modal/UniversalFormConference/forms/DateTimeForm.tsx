...
export function DateTimeForm({
  ...
  // Округление вверх до ближайшей минуты
  ...
  const [selectedDate, setSelectedDate] = useState<Date | undefined>(() => {
    const baseDate = started_at ? new Date(started_at) : new Date();
    return roundUpToNextMinute(baseDate);
  });
  ...
  return (
    <div className="text-base font-medium grid grid-cols-1 gap-6">
      <div className="flex flex-col">
        ...
        <DateTimePicker
          ...
          onChange={(date) => {
            ...
            const roundedDate = date ? roundUpToNextMinute(date) : undefined;
