  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: 'h-9 w-9 text-center text-sm p-0 relative [&:has([aria-selected].day-range-end)]:rounded-md [&:has([aria-selected].day-outside)]:bg-accent/50 [&:has([aria-selected])]:bg-accent focus-within:relative focus-within:z-20 ',
        day: cn(
      ...
      components={{
        ...
        Caption: ({ displayMonth }) => {
          return (
            <div className="inline-flex gap-2 px-8 py-0">
              <Select
              ...
              >
                <SelectTrigger className="w-fit gap-1 pl-4 pr-2 border-none focus:bg-accent focus:text-accent-foreground">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  {MONTHS.map((month) => (
              ...
              >
                <SelectTrigger className="w-fit gap-1 border-none pl-4 pr-2 focus:bg-accent focus:text-accent-foreground">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  {YEARS.map((year) => (
  ...
  (
    ...
    return (
      <Input
        ...
        name={name || picker}
        className={cn(
          'w-[48px] border-opacity-10 border-white border text-center font-mono text-base tabular-nums caret-transparent focus:bg-accent focus:text-accent-foreground [&::-webkit-inner-spin-button]:appearance-none',
          className,
        )}
  ...
  (
    ...
    return (
      <Popover>
        ...
        <PopoverContent className="w-auto p-0 bg-gray-2 text-white border-white border border-opacity-10">
          <Calendar
            mode="single"
          ...
          />
          {granularity !== 'day' && (
            <div className="border-t border-opacity-10 border-white p-3">
              <TimePicker
                onChange={(value) => {
                  onChange?.(value);
